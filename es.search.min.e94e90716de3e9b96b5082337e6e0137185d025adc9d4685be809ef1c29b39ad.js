...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.a70d1dd98cfdc987be6e344cce89d4eacc4ea757d1f978be8592e0e0b69079a7.js',function(){input.required=false;search();});}
