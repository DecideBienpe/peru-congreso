...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.aa75bfaefa67b32bcae4661890ce538fa90f05a80d1739fe1756b5786c4671ef.js',function(){input.required=false;search();});}
