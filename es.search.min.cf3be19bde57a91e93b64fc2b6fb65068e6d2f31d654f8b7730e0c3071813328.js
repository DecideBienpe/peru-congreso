...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.24010a3c03d9a0ac4bb8d368df34bbd52b8d9d3015fa499696c7befdc200a0e6.js',function(){input.required=false;search();});}
