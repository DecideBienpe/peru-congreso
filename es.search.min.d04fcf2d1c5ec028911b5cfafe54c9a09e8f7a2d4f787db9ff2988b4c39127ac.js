...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.c0e1e1aff4f47ce3e127d9d6e9fc8a447dc46d750a8ff38de78be730113feebd.js',function(){input.required=false;search();});}
